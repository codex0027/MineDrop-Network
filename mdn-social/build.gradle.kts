// MDN-Social — Friends, Clans/Teams (Paper)
...
tasks.processResources { filesMatching("plugin.yml") { expand("mainClass" to "net.minedrop.social.SocialPaperPlugin", "version" to project.version) } }
