...
public final class AuthManager {
    ...
    public AuthManager(RedisManager redisManager, Logger logger) {
        ...
        this.totpManager = new TotpManager(redisManager, objectMapper, logger);
    ...
    /** Creates the {@link TwoFactorCommand} wired to this manager, with a post-verify callback. */
    public TwoFactorCommand createTwoFactorCommand(
        ...
        return new TwoFactorCommand(this, logger, onVerified);
    }
